{**plugins/generic/viewcounter/templates/frontend/objects/article_details.tpl*}
<article class="obj_article_details">
	...
	{/if}
	<p><i class='fa fa-bar-chart' style='color: red'></i> Total de visualizações: <b>{$article->getViews()}</b> </p>
	<div class="row">
				...
				<div class="item galleys">
					...
					<ul class="value galleys_links">
						{foreach from=$primaryGalleys item=galley}
							...
							<i class='fa fa-download' style='color: red'></i> {$galley->getViews()}
							</li>
						{/foreach}
					</ul>
				</div>
